...
while launched:
    ...
    # Welcome player
    game.text_wait(f"Welcome {game.player._name} !\n", game.bg, (250, 280), 2, constants.IMMORTAL_BIG)
    ...
    while continue_game:
        ...
        if shoping:
            ...
            while continue_shop:
                ...
                p_choice = game.ask_check_img(scn.shop_menu, game.img_shop, ['Buy', 'Sell', 'Exit'], (150, 260),
                                              subtext=game.pane)
                # Sell item
                ...
                # BUY ITEM
                    ...
                    look_stock = game.ask_check_img(scn.which_stock, game.img_shop, ['Armours', 'Spells', 'Weapons'],
        ...
        if fight_result == "You win the fight !\n":
